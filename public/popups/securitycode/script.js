function Pop() {
    ...
    let createPopUp = function () {
        if (typeof conDivObj === "undefined") {
            ...
            imgObj.setAttribute("src", "./popup-generator/logo-image/star.svg")
    ...
    this.init = function (param) {
        console.log("Pop wiil load new params")
        if (typeof param === "object") {
            ...
            if("contents" in param && typeof param["contents"] === "object"){
                ...
                if("content5" in param["contents"]) content.contents.content5 = param["contents"]["content5"]
            }
            createPopUp()
        }
    }
