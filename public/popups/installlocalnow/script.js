function Pop() {
    ...
    let createPopUp = function () {
        if (typeof conDivObj === "undefined") {
            ...
            imgObj.style.width = (content.size == "large") ? "420px" : ((content.size == "medium") ? "400px" : "370px" )
            imgDivObj.appendChild(imgObj)
            conDivObj.appendChild(imgDivObj)


            contentConteiner = document.createElement("DIV");
            contentConteiner.style.marginTop = (content.size == "large") ? "40px" : ((content.size == "medium") ? "32px" : "24px" )
            contentConteiner.style.marginBottom = (content.size == "large") ? "40px" : ((content.size == "medium") ? "32px" : "24px" )

            content1DivObj = document.createElement("DIV");
            content1DivObj.innerHTML = content.contents.content1
            content1DivObj.style.marginBottom = (content.size == "large") ? "12px" : ((content.size == "medium") ? "8px" : "4px" )
            content1DivObj.style.fontSize = (content.size == "large") ? "30px" : ((content.size == "medium") ? "24px" : "20px" )
            ...
            content2DivObj.style.marginBottom = (content.size == "large") ? "20px" : ((content.size == "medium") ? "16px" : "12px" )
            content2DivObj.style.fontSize = (content.size == "large") ? "20px" : ((content.size == "medium") ? "18px" : "16px" )
    ...
    this.init = function (param) {
        if (typeof param === "object") {
            ...
            if("contents" in param && typeof param["contents"] === "object"){
                if("content1" in param["contents"]) content.contents.content1 = param["contents"]["content1"]
                if("content2" in param["contents"]) content.contents.content2 = param["contents"]["content2"]
                if("content3" in param["contents"]) content.contents.content3 = param["contents"]["content3"]
                if("content4" in param["contents"]) content.contents.content4 = param["contents"]["content4"]
            }
            createPopUp()
        }
    }
